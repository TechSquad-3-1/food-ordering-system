...
const Footer = () => {
  return (
    <footer className="bg-cover bg-center bg-gradient-to-b from-orange-50 to-orange-500 border-t py-3">
      <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-black-400 hover:text-gray-600">
          ...
          <div className="border-t mt-8 pt-8 text-center text-white text-sm">
